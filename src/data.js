export const PARAGRAPHS = {
  ...
  6: "Six big devils from Japan quickly forgot how to waltz.",
  7: "Cwm fjord bank glyphs vext quiz.",
  8: "Jinxed wizards pluck ivy from the big quilt.",
  9: "the quick onyx goblin jumps over the lazy dwarf",
  10: "Mr. sphinx, please crunch fifty dozen liquor jugs.",
  11: "Waltz, nymph, for quick jigs vex Bud.",
  12: "Bright vixens jump; dozy fowl quack."
}